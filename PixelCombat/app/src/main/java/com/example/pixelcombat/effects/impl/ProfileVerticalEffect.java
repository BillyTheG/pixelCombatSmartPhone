...
public class ProfileVerticalEffect extends Effect {

    private ImageMover imageMover;

    public ProfileVerticalEffect(ArrayList<LocatedBitmap> images, ArrayList<Float> times, Vector2d pos, boolean scale) {
